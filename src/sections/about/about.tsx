    ...
    <section className="about" id="about">
      <div className="about__text-container">
        ...
        <p className="about__text">
          ...
          Konuşmalar, paneller, atölyeler ve ilham dolu hikâyelerle, kadın-erkek
          herkesin katılımına açık bu etkinliklerde birlikte öğreniyor, birlikte
          gelişiyoruz. Bu yıl biz de GDG Antalya ve Women Techmakers Antalya
          olarak IWD 2026’i kutlamak için heyecanla hazırlanıyoruz. Çünkü
          biliyoruz ki teknoloji, ancak çeşitlilikle gelişir 💪
